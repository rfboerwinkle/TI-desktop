...
WriteFlashByte:
	...
	push bc
		...
		push bc
			...
			ld de, FlashExecutableRAM
			ld bc, WriteFlashByte_RAM_End - WriteFlashByte_RAM
			ldir
		pop bc
		pop de
		pop hl
		call FlashExecutableRAM
	pop bc
	pop de
	pop hl
...
CopySectorToSwap:
  ...
  push af
    ...
    ld de, FlashExecutableRAM + $4000 ; By rearranging memory, we can make the routine perform better
